        ...
        <main class="col-md-10 ms-sm-auto px-4">
            <div class="container py-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2 class="fw-bold text-info"><i class="bi bi-person-circle me-2"></i>Customer Details</h2>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="d-flex align-items-center mb-4">
                                    <div class="avatar bg-info bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 60px; height: 60px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <p class="fs-5">
                                            <span class="badge bg-info fs-6">{{ ucfirst($customer->role) }}</span>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <p class="fs-5">{{ $customer->created_at->format('F j, Y') }}</p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label fw-semibold text-muted">Last Updated</label>
                                        <p class="fs-5">{{ $customer->updated_at->format('F j, Y g:i A') }}</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="bg-light rounded-3 p-3 text-center">
                                    ...
                                    <div class="d-grid gap-2">
                                        ...
                                        <form action="{{ route('admin.customers.destroy', $customer) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm w-100" onclick="return confirm('Are you sure you want to delete this customer?')">
